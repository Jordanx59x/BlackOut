...
switch(true) do
{
	...
	{
		[[0,"News : Interpôle a arrété un trafic de drogue international!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	...
	{
		[[0,"News : Baisse du baril de pétrole!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	...
	{
		[[0,"News : La Chine construit le China World Center!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	...
	{
		[[0,"News: Baisse du prix de l'or!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	...
	{
		[[0,"News: L'industrie de l'électronique a besoin de métaux précieux!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	...
	{
		[[0,"News: Le cour du dollar baisse!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	...
	{
		[[0,"News: Une nouvelle drogue synthétique inonde le marché de la drogue!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	...
	{
		[[0,"News: La Chine découvre des tortues comme une nouvelle médecine! Des défenseurs d'animaux sont partagés!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
